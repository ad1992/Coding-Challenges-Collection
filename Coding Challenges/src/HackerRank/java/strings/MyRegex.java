 ...
 *         B, C, and D may range from 0 to 255. Leading zeros are allowed. The
 ...
 * 
 *         Just write the myRegex class, and we will append your code after the
 *         following piece of code automatically before running it:
 * 
 */
public class MyRegex {
	static String pattern = "^((0?[0-9]?[0-9]|[1][0-9][0-9]|2[0-4][0-9]|25[0-5]).){3}(0?[0-9]?[0-9]|[01][0-9][0-9]|2[0-4][0-9]|25[0-5]){1}$";
